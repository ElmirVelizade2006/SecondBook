...
<div class="dashboard-section faq-page">
    ...
    <div class="dashboard-panel mb-4">
        ...
        <div class="panel-header mb-0">
            ...
            <div>
                <h5 class="mb-1">Add FAQ</h5>

                <p class="text-muted mb-0 small">
                    Create a new frequently asked question for SecondBook
                </p>
            </div>
                ...
                <div class="dashboard-panel faq-tip-panel">
                    ...
                    <div class="panel-header">
                        ...
                        <div>
                            ...
                            <p class="text-muted mb-0 small">
                                Keep your FAQs useful and easy to understand.
                            </p>
                        </div>
                    ...
                    <div class="faq-tip-list">
                        ...
                        <div class="faq-tip-item">
                            ...
                            <div>
                                ...
                                <p>
                                    Write questions in a simple and natural way.
                                </p>
                            </div>
                        ...
                        <div class="faq-tip-item">
                            ...
                            <div>
                                ...
                                <p>
                                    Give users a direct and understandable answer.
                                </p>
                            </div>
                ...
                <div class="dashboard-panel faq-tip-box mt-4">
                    ...
                    <div class="d-flex gap-3">
                        ...
                        <div>
                            ...
                            <p class="mb-0 small">
                                Only active FAQs will be available for display
