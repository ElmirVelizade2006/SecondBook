    ...
    <div class="container">
            ...
            <div class="authors-grid">
                ...
                @foreach($authors as $index => $author)
                    ...
                    @php
                        ...
                        $authorImage = $authorImages[$index % count($authorImages)];
                    @endphp
                    ...
                    <article class="author-card">
                        ...
                        <div class="author-card-content">
                            ...
                            <p>
                                Discover books and stories from
                                {{ $author->name }}.
                            </p>

                            <a
                                href="{{ route('frontend.books', ['author' => $author->id]) }}"
        ...
        @else
            ...
            <div class="authors-empty">
                ...
                <h3>No authors available yet</h3>
        ...
        <div class="authors-discovery-box">
            ...
            <div class="row align-items-center g-5">
                ...
                <div class="col-lg-7">
                    ...
                    <a href="{{ route('frontend.books') }}" class="discovery-btn">
...
<section class="authors-cta">
    <div class="container">
        ...
        <div class="authors-cta-content">
            ...
            <a href="{{ route('frontend.books') }}" class="authors-cta-btn">
                Browse Books
                <i class="bi bi-arrow-right"></i>
            </a>
